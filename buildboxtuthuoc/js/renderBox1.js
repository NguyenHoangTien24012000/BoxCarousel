function renderBox(){
    ...
    <div class="gknews_box" type="newest">
        <div class="noticeable-news">
            <h3>
                <a href="" title="My GenK" class="noticeable-news-title">My GenK</a>
            </h3>
            <ul class="list-nn" algid="22" boxid="4" dspid="61">
                <li class="nn-item first-noticeable-news" ispopup="1" style="display: list-item;">
                    <div class="item-gr">
                        <div class="item-news">
                            <a data-url="" href="" title="Xperia 10 IV lộ diện với thiết kế cũ, chip Snapdragon 690, pin 4000mAh" class="item-news-thumb">
                                <i><img src="https://genk.mediacdn.vn/thumb_w/240/139269124445442048/2022/3/7/gsmarena003-1646672181993-16466721822431316113002-0-69-675-1149-crop-16466722878812070527852.jpg" alt="Xperia 10 IV lộ diện với thiết kế cũ, chip Snapdragon 690, pin 4000mAh"></i>
                            </a>
                            <h4>
                                <a data-url="" href="" title="Xperia 10 IV lộ diện với thiết kế cũ, chip Snapdragon 690, pin 4000mAh"
                                    class="item-news-title">Xperia 10 IV lộ diện với thiết kế cũ, chip Snapdragon 690, pin 4000mAh</a>
                            </h4>
                        </div>
                    </div>
                </li>
                <li class="nn-item" ispopup="1" style="display: list-item;">
                    <div class="item-gr">
                        <div class="item-news">
                            <h4>
                                <a data-url="" href="" title="Samsung hạ bệ Xiaomi, thiết lập kỷ lục Guinness mới với Galaxy S22 Ultra"
                                    class="item-news-title">Samsung hạ bệ Xiaomi, thiết lập kỷ lục Guinness mới với Galaxy S22 Ultra</a>
                            </h4>
                            <a data-url="" href="" class="item-news-thumb"> <i><img
                                        src="https://genk.mediacdn.vn/thumb_w/240/139269124445442048/2022/3/8/galaxy-s22-series-genk-2-1644422279137334469850-16467408745301275889152-83-0-1333-2000-crop-1646740897786431280927.jpg" alt="Samsung hạ bệ Xiaomi, thiết lập kỷ lục Guinness mới với Galaxy S22 Ultra"></i>
                            </a>
                        </div>
                    </div>
                </li>
                <li class="nn-item" ispopup="0" style="display: list-item;">
                    <div class="item-gr">
                        <div class="item-news">
                            <h4>
                                <a data-url="" href="" title="Đáp ứng mọi tác vụ trên một chiếc smartphone, realme 9 Pro hút người mua khi tung giá bán chỉ dưới 8 triệu kèm loạt ưu đãi khủng"
                                    class="item-news-title">Đáp ứng mọi tác vụ trên một chiếc smartphone, realme 9 Pro hút người mua khi tung giá bán chỉ dưới 8 triệu kèm loạt ưu đãi khủng</a>
                            </h4>
                            <a data-url="" href="" class="item-news-thumb"> <i><img
                                        src="https://genk.mediacdn.vn/thumb_w/240/139269124445442048/2022/3/9/avatar1646821427346-16468214283231638376956.jpg" alt="Đáp ứng mọi tác vụ trên một chiếc smartphone, realme 9 Pro hút người mua khi tung giá bán chỉ dưới 8 triệu kèm loạt ưu đãi khủng"></i>
                            </a>
                        </div>
                    </div>
                </li>
                <li class="nn-item" ispopup="1" style="display: list-item;">
                    <div class="item-gr">
                        <div class="item-news">
                            <h4>
                                <a data-url="" href="" title="Keanu Reeves trở thành Batman mới trong bom tấn hoạt hình của DC, vẫn nuôi chó như John Wick"
                                    class="item-news-title">Keanu Reeves trở thành Batman mới trong bom tấn hoạt hình của DC, vẫn nuôi chó như John Wick</a>
                            </h4>
                            <a data-url="" href="" class="item-news-thumb"> <i><img
                                        src="https://genk.mediacdn.vn/thumb_w/240/139269124445442048/2022/3/8/ava-1646705851560187661841-0-28-720-1180-crop-164670585796244207243.jpg" alt="Keanu Reeves trở thành Batman mới trong bom tấn hoạt hình của DC, vẫn nuôi chó như John Wick"></i>
                            </a>
                        </div>
                    </div>
                </li>
